...
<p align="center">
  ...
  <a href="https://marketplace.visualstudio.com/items?itemName=Vizards.ultracode-for-copilot"><img src="https://img.shields.io/badge/VS%20Code%20Marketplace-Install-007ACC?logo=visualstudiocode&logoColor=white&style=for-the-badge" alt="从 VS Code Marketplace 安装"></a>
  <a href="https://open-vsx.org/extension/Vizards/ultracode-for-copilot"><img src="https://img.shields.io/badge/Open%20VSX-Install-6A4FB6?style=for-the-badge" alt="从 Open VSX 安装"></a>
  <br/>
  <!-- marketplace-readme:remove-end -->
  <img src="https://img.shields.io/github/v/release/nolanrpg/ultracode-for-copilot?style=for-the-badge&label=Version" alt="版本" />
</p>

<p align="center">
  <a href="https://github.com/nolanrpg/ultracode-for-copilot/blob/main/README.md">English</a> |
  简体中文
</p>

**Copilot Chat 的 Ultracode 模式——灵感来自 Claude Code 的 Ultracode effort 模式。深度推理、Agent 工具、视觉代理、BYOK。**

<p align="center">
  <img src="resources/screenshots/01-picker.png" alt="Ultracode 模式出现在 Copilot Chat 模型选择器中，带有可按模型独立设置的思考深度下拉菜单（停用 / 标准 / 深度）" width="800">
</p>

想要 Claude Code 级别的 Ultracode 体验，但不想离开 Copilot Chat？本扩展将 **Ultracode 模式** 带入 Copilot——基于 DeepSeek V4 Pro 和 Flash——支持**视觉识别**、**思考模式**，使用你自己的 API Key。

## 为什么选这个扩展？

- **Copilot 的 Ultracode 模式。** 灵感来自 Claude Code 的 Ultracode effort 模式——深度推理、多步骤 Agent 执行、值得信赖的周密性。
- **不是替换 Copilot，而是增强它。** 没有新的侧边栏，没有新的聊天界面需要学习。只是在你已经在用的模型选择器中多了一个选项。
- **Agent 模式、工具调用、Instructions、MCP、Skills——全部正常运作。** Copilot 的完整能力栈，现在跑在 DeepSeek V4 上。
...
- VS Code 1.116 及以上版本。本扩展依赖非公开的 Copilot Chat API，较新的 VS Code 版本可能存在兼容性问题——如遇到请[提交 Issue](https://github.com/nolanrpg/ultracode-for-copilot/issues)。
...
1. **Microsoft VS Code** — 从 [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=Vizards.ultracode-for-copilot) 安装。
2. **使用 Open VSX 的编辑器** — 从 [Open VSX](https://open-vsx.org/extension/Vizards/ultracode-for-copilot) 安装。

### 使用步骤

1. 通过命令面板（`Cmd+Shift+P`）运行 **Ultracode: 设置 API Key**
2. 粘贴你的 Key 或兼容的 provider token（官方 DeepSeek Key 通常以 `sk-` 开头）
3. 打开 Copilot Chat，点击模型选择器，选择 **DeepSeek V4 Pro** 或 **DeepSeek V4 Flash**
4. 完成 — 开始 Ultracode 模式聊天
4. 搞定——开始聊天
